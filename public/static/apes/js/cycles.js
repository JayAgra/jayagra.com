const CYCLES = [
        ...
        steps: [
            {
                ...
                html: "<p>The carbon cycle refers to how carbon transfers between different carbon sinks located on Earth. It is vital for maintaining a stable climate and carbon balance on our planet. Carbon is the lifeblood of Earth and is naturally regulated by the carbon cycle. Without it, the Earth would be frozen.</p>",
            },
            {
                title: "Fossil Fuels",
                brief: "Fossil Fuels are used for electricity, transportation, production, and heating.",
                html: '<p>Fossil fuels are non-renewable energy sources that formed from the fossilized remains of ancient organisms. These are carbon-rich sources of energy, mainly being coal, gas, and oil. We use these to do many things that we find to be essential with the current way we live. Burning fossil fuels creates large amounts of carbon dioxide in the atmosphere, which is a significant <span class="tooltip">anthropogenic</span> source of global warming. This human activity has been rapidly increasing and is creating more and more trouble for the natural carbon cycle.</p>',
            },
            {
                title: "The Food Chain",
                brief: "Carbon is transferred through the food chain and organisms release carbon when they decompose.",
                html: '<p>Plants utilize <span class="tooltip">photosynthesis</span> to take in carbon dioxide and release oxygen into the atmosphere, allowing most organisms to breathe. All organisms also release carbon when they are converting food to usable energy, this is called <span class="tooltip">cellular respiration</span>. The respiration releases the carbon back into the atmosphere. The carbon is also circulating through the food chain, with it being transferred to the consumer. Eventually the organisms will die, and as they decompose they release carbon dioxide back to the atmosphere.</p>',
            },
            {
                title: "Deforestation",
                brief: "Deforestation causes reduced carbon uptake by plants.",
                html: "<p>When trees are cut down, this has various negative effects. Mass deforestation results in the gross primary production of the plants to be significantly reduced, which in turn decreases the amount of carbon dioxide that is taken out of the atmosphere and changed into oxygen.</p>",
            },
            {
                title: "Volcanic Activity",
                brief: "Volcanic Eruptions can release carbon dioxide into the atmosphere.",
                html: "<p>When magma rises from the earth's mantle, it collects in magma chambers. Through vents and fissures in the Earth's crust the magma rises out, causing an eruption. During the eruption dissolved gases are released into the atmosphere, this includes carbon.</p>",
            },
            {
                title: "Ocean and Carbon",
                brief: "The ocean is a crucial part of the carbon cycle, capturing and releasing carbon.",
                html: "<p>The ocean takes in carbon, but also will release it. Some factors that affect this are the salinity and temperature of the water. During rain, water can travel over soil surfaces and carry away carbon into various bodies of water, eventually going into the sea. The largest carbon sink on the planet, capable of storing 50 times as much carbon than the atmosphere. Due to the increased carbon from burning fossil fuels, when the ocean takes in all this extra carbon the pH levels drop. The decrease in pH levels is called ocean acidification, which can cause trouble for organisms that need to build their shells or skeletons.</p>",
            },
            {
                title: "Aquatic Life",
                brief: "Aquatic Food Chain and Decomposition.",
                html: "<p>When living organisms break down sugars for energy, they take in O<sub>2</sub> and release CO<sub>2</sub> back into the water and the gas dissolves. Plants absorb the CO<sub>2</sub> in the atmosphere through photosynthesis to create sugars, they then release O<sub>2</sub>. Aquatic plants take in CO<sub>2</sub> mainly from its dissolved form in water. When organisms die, they release the carbon that was stored within them back into the environment. Decomposers play a large role in this process, breaking down the dead organisms and returning nutrients to the environment.</p>",
            },
        ],
    },
    {
    ...
    },
    {
        ...
        steps: [
            {
                title: "All",
                brief: "Nitrogen is an essential component to life on earth",
                html: "<p>The nitrogen cycle matters because nitrogen is an essential nutrient for sustaining life on Earth. Nitrogen is a core component of amino acids, which are the building block of proteins, and of nucleic acids, which are the building blocks of genetic material (RNA and DNA).</p>",
            },
            {
                title: "Nitrogen Fixation",
                brief: "Gas turns to ammonia",
                html: '<p>Nitrogen fixation is where the gas is converted into ammonia (NH3). This process is mainly accomplished by bacteria and blue-green algae. Some of the nitrogen is fixed through abiotic means like lightning, UV radiation, electrical equipment. The nitrogen can also be fixed through the <span class="tooltip">Haber-Bosch process</span>.</p>',
            },
            {
                title: "Ammonification",
                brief: "Conversion of remains and waste",
                html: "<p>The remains of all living things and their waste products are decomposed by microorganisms, creating ammonia (NH<sub>3</sub>) and ammonium (NH<sub>4</sub>+). The ammonia can leave the soil or be converted into other nitrogen compounds, depending in part on soil conditions.</p>",
            },
            {
                title: "Nitrification",
                brief: "Soil ammonia turns to nitrates and nitrites",
                html: "<p>Carried out by nitrifying bacteria, they transform soil ammonia into nitrates (NO<sub>3</sub>) and nitrites (NO<sub>2</sub>, which plants can use and incorporate into their tissue.</p>",
            },
            {
                title: "Denitrification",
                brief: "Nitrates turn to gaseous forms",
                html: "<p>Denitrification is the process where microorganisms convert nitrates into gaseous forms of nitrogen, including nitrous oxide and nitrogen gas. This process is significant to the nitrogen cycle as it influences soil health, water quality, and the environment.</p>",
            },
            {
                title: "Assimilation",
                brief: "Nitrates and ammonia go into algae and plants",
                html: '<p>Nitrates and ammonia from nitrogen fixation are assimilated into specific tissue compounds of algae and <span class="tooltip">higher plants</span>. Animals then ingest these algae and plants, converting them into their own body compounds.</p>',
            },
            {
                title: "Decomposition",
                brief: "Nitrogen released after organisms die",
                html: "<p>Decomposers break down dead organic matter and release nutrients back into the soil. The nitrogen in the dead organic matter is converted into a form that plants can use, regulating the amount of nitrogen available in the environment.</p>",
            },
        ],
    },
    {
        ...
        steps: [
            {
                title: "All",
                brief: "The phosphorous cycle is central to sustaining life on Earth.",
                html: "<p>The phosphorus cycle matters because phosphorus is an essential nutrient for sustaining life on Earth, where it plays a central role in the transfer of energy within organisms, the structure of the genetic material, and in the composition of cell membranes, bones and teeth.</p>",
            },
            {
                title: "Under the Surface",
                brief: "Phosphorus in sedimentary rock makes its way to the surface.",
                html: "<p>Phosphorus is rare and it mostly exists as different types of compounds, like phosphate. The phosphate is released from the sedimentary through weathering and erosion, these break down the rocks letting out phosphate ions into the soil and water. Thus allowing the phosphate to reach the surface and join into more rocks near the surface.</p>",
            },
            {
                title: "Release",
